...
class Feedback:
    ...
    def __init__(self, master):
        ...
        ttk.Label(self.frame_header,wraplength = 300,  text = ("We are glad you chose Explore California for your recent adventure."
    ...
    def submit(self):
        ...
        self.clear()
        messagebox.showinfo(title = "Explore Clifornia Feedback", message = "Comments Submitted!")
